...
ROUTER = {
    "root": {"url": "/", "GET": "controller.handle"},
    "wallet-address": {"url": "/wallet/{wallet_address}", "GET": "wallet.get_wallet.get_wallet_from_request"},
    "wallet-history": {
    ...
    "change-trust-add-token": {
        ...
        "GET": "transaction.get_unsigned_change_trust.get_unsigned_add_trust_and_hot_from_request",
    },
    ...
    "metrics": {"url": "/metrics", "GET": "request_tracking.metrics.get_metrics"},
}
